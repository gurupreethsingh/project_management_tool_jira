...
// 	String failedScreenshotsFolder = rootDirectory + File.separator + "failedScreenshots";
...
//		    // Project root = current working directory (IDE/Maven/Gradle usually set this to project root)
//		    Path ROOT_DIRECTORY = Path.of("").toAbsolutePath().normalize();
		//
//		    // Relative resources (portable across Windows/macOS/Linux)
//		    Path EXCEL_SHEET = ROOT_DIRECTORY.resolve("project_documents.xlsx");
//		    Path FAILED_SCREENSHOTS_DIR = ROOT_DIRECTORY.resolve("failedScreenshots");
		
//		    // If some libraries insist on String paths:
