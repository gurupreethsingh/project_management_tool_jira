...
const pillars = [
  ...
  {
    title: "Friendly Support",
    desc: "We’re here to help with fast responses and real human support.",
    icon: FaHeadset,
  },
];
...
const values = [
  ...
  {
    title: "Great Deals",
    desc: "Daily discounts and seasonal offers that give you real value.",
    icon: MdOutlineLocalOffer,
  },
  {
    title: "Customer Love",
...
const trustCards = [
  {
    icon: FaShieldAlt,
    title: "Shop with confidence",
    desc: "Fraud protection and safe payments for every order.",
  },
  {
    icon: FaTags,
    title: "Real deals, real value",
    desc: "Discounts you can trust across trending categories.",
  },
  {
    icon: FaHeadset,
    title: "Support that cares",
    desc: "Quick help and clear answers when you need them.",
  },
];
...
const iconWrap =
  "h-11 w-11 sm:h-12 sm:w-12 rounded-2xl bg-orange-50 border border-orange-100 flex items-center justify-center shrink-0";

export default function AboutUs() {
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-white via-orange-50/30 to-white text-gray-900">
      <div className="mx-auto w-full container px-4 sm:px-6 lg:px-8 xl:px-10">
        {/* HERO */}
        <section className="pt-5 sm:pt-7 lg:pt-8">
          <div className="relative overflow-hidden rounded-[24px] sm:rounded-[28px] border border-orange-100 bg-white shadow-[0_20px_60px_-30px_rgba(251,146,60,0.35)]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(251,146,60,0.14),transparent_30%),radial-gradient(circle_at_bottom_left,rgba(251,191,36,0.12),transparent_28%)]" />

            <div className="relative p-5 sm:p-7 lg:p-10 xl:p-12">
              <div className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-3.5 py-2 text-[11px] sm:text-xs font-extrabold uppercase tracking-[0.18em] text-orange-700">
                <HiOutlineSparkles className="text-orange-600 text-sm" />
                About Our Store
              </div>

              <div className="mt-5 grid grid-cols-1 gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8 xl:gap-10">
                <div className="flex flex-col justify-center">
                  <h1 className="max-w-3xl text-[28px] leading-[1.15] sm:text-[38px] lg:text-[48px] xl:text-[56px] font-extrabold tracking-tight">
                    Modern shopping,{" "}
                    <span className="text-orange-600">built for speed</span> and{" "}
                    <span className="text-orange-600">trust</span>.
                  </h1>

                  <p className="mt-4 max-w-2xl text-sm sm:text-[15px] lg:text-base leading-7 text-gray-600">
                    We’re an e-commerce platform focused on quality products,
                    smooth checkout, and fast delivery. From trending gadgets to
                    everyday essentials, we help you shop confidently with
                    secure payments, easy returns, and responsive support.
                ...
                <div className="rounded-[22px] border border-orange-100 bg-white/95 p-4 sm:p-5 lg:p-6 shadow-sm backdrop-blur">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-gray-900">
                        Our Impact
                      </p>
                      <p className="mt-1 text-xs sm:text-sm text-gray-500">
                        Built on trust, scale, and customer satisfaction
                      </p>
                    </div>

                    <div className="inline-flex items-center gap-2 rounded-full bg-orange-50 px-3 py-2 text-[11px] sm:text-xs font-bold text-orange-700">
                      <FaCheckCircle className="text-orange-600" />
                      Verified experience
                    </div>
                  </div>
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-3">
                    {stats.map((item) => {
                      ...
                      return (
                        <div
                          key={item.label}
                          className="rounded-2xl border border-orange-100 bg-gradient-to-b from-orange-50/70 to-white p-4"
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0">
                              <p className="text-lg sm:text-xl font-extrabold leading-none text-gray-900">
                                {item.value}
                              </p>
                  ...
                  <div className="mt-4 rounded-2xl border border-orange-200 bg-gradient-to-r from-orange-100 to-amber-100 p-4">
                    <div className="flex items-start gap-3">
                      <div className="h-11 w-11 rounded-2xl bg-white border border-orange-200 flex items-center justify-center shrink-0">
                        <FaStar className="text-orange-600" />
                      </div>
                      <div>
                        ...
                        <p className="mt-1 text-xs sm:text-sm text-gray-600">
                          Consistent quality, reliable delivery, and a smooth
                          shopping experience.
                        </p>
                      </div>
                    </div>
        ...
        <section className="mt-10 sm:mt-12 lg:mt-14">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="text-[24px] sm:text-[30px] font-extrabold tracking-tight text-gray-900">
                What we focus on
              </h2>
              <p className="mt-1 text-sm sm:text-[15px] text-gray-600">
                The core things that keep shopping smooth, secure, and reliable.
              </p>
            </div>

            <div className="inline-flex w-fit items-center gap-2 rounded-full border border-orange-100 bg-orange-50 px-4 py-2 text-xs font-bold text-orange-700">
              <FaStore className="text-orange-600" />
              Built for e-commerce
            </div>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {pillars.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group rounded-[24px] border border-orange-100 bg-white p-5 sm:p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg"
                >
                  <div
                    className={`${iconWrap} group-hover:bg-orange-100 transition`}
                  >
                    <Icon className="text-orange-600 text-[20px]" />
                  </div>

                  <h3 className="mt-4 text-[15px] sm:text-base font-extrabold text-gray-900">
                    {item.title}
                  </h3>
        ...
        {/* VALUES */}
        <section className="mt-10 sm:mt-12 lg:mt-14">
          <div className="overflow-hidden rounded-[24px] sm:rounded-[28px] border border-orange-100 bg-white shadow-sm">
            <div className="p-5 sm:p-7 lg:p-10">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="inline-flex w-fit items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-4 py-2 text-xs font-bold text-orange-700">
                  <FaHeart className="text-orange-600" />
                  Customer-first mindset
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {values.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="rounded-[22px] border border-orange-100 bg-gradient-to-b from-orange-50/60 via-white to-white p-5"
                    >
                      <div className="flex items-center gap-3">
                        <div className={iconWrap}>
                          <Icon className="text-orange-600 text-[18px]" />
            ...
            <div className="border-t border-orange-100 bg-gradient-to-r from-orange-50 to-amber-50 px-5 py-4 sm:px-7 lg:px-10">
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-900">
                  <FaCheckCircle className="text-orange-600" />
                  Verified sellers • Secure checkout • Easy returns
                </div>

                <div className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-orange-700">
                  <RiSecurePaymentFill className="text-orange-600" />
                  Encrypted payments & buyer protection
                </div>
              </div>
        ...
        {/* CTA */}
        <section className="mt-10 sm:mt-12 lg:mt-14 pb-10 sm:pb-12 lg:pb-14">
          <div className="relative overflow-hidden rounded-[24px] sm:rounded-[28px] bg-gradient-to-r from-orange-500 via-orange-500 to-amber-400 shadow-[0_18px_50px_-20px_rgba(249,115,22,0.65)]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_25%),radial-gradient(circle_at_bottom_left,rgba(255,255,255,0.14),transparent_30%)]" />

            <div className="relative p-5 sm:p-7 lg:p-10 text-white">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div className="max-w-2xl">
                  <h3 className="text-[24px] sm:text-[30px] font-extrabold tracking-tight">
                    Ready to explore our best deals?
                  </h3>
                  <p className="mt-2 text-sm sm:text-[15px] leading-7 text-white/90">
                    Browse categories, search brands, and discover trending
                    products in a fast, modern shopping experience.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <a
                    href="/shop"
                    className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-sm font-extrabold text-orange-700 shadow-sm transition hover:scale-[1.02]"
                  >
                    Shop Now
                  ...
                  <a
                    href="/contact-us"
                    className="inline-flex items-center justify-center rounded-2xl border border-white/25 bg-white/10 px-6 py-3.5 text-sm font-extrabold text-white transition hover:bg-white/15"
                  >
                    Contact Us
                  </a>
                </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                {ctaBadges.map((item) => {
                  ...
                  return (
                    <div
                      key={item.text}
                      className="flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-4 py-3"
                    >
