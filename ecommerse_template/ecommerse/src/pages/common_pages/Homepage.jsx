...
//                 >
//                   <div className="relative">
//                     <div className="w-full h-[115px] sm:h-[130px] md:h-[140px] lg:h-[150px] bg-gradient-to-br from-orange-50 via-white to-amber-50 flex items-center justify-center p-3">
//                       <img
//                         src={`${globalBackendRoute}/${cat.category_image}`}
//                         alt={cat.category_name}
...
//                   >
//                     <div className="relative">
//                       <div className="w-full aspect-square bg-gradient-to-br from-orange-50 via-white to-amber-50 flex items-center justify-center p-3">
//                         <img
//                           src={resolveProductImage(item)}
//                           alt={item.product_name}
//                           className="w-full h-full object-contain"
