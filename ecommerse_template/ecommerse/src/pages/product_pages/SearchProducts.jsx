...
//   // ✅ Forces sidebar filters to reset when a new search is triggered from the header
...
//   // ✅ read ?query= from URL.
//   // IMPORTANT: if the user searches again from the header while already on this page,
//   // reset old sidebar selections; otherwise old brand/category filters override new results.
//   useEffect(() => {
...
//   // ✅ SearchProducts-specific reset:
//   // Clear Filters must show ALL products again, not only the products from the old search query.
...
//     // ✅ On SearchProducts, Clear Filters means: show every active product again.
//     // This fixes the blank/locked state after coming from a brand/category search.
...
//                           // ✅ If the user deselects the last selected brand that came from a header search,
//                           // restore all products instead of keeping the page blank/locked to old results.
//                           if (
//                             alreadySelected &&
//                             updated.length === 0 &&
//                             !selectedCategory &&
...
// not seeing all products , after the click on clear filter button.
