...
// ✅ SINGLE FILE: SearchProducts + FiltersSidebar + Pagination + Product views (grid/card/list)
// ✅ UI 100% identical to Shop.jsx (same CSS + same buttons + same structure)
// ✅ FUNCTIONALITY preserved from your SearchProducts:
// - query taken from URL (?query=...)
// - debounce search applied
// - wishlist + cart logic preserved
// - pagination + view modes preserved
// ✅ IMPORTANT: Search works first, then sidebar filters apply on top of search results
...
export default function SearchProducts() {
  ...
  // ✅ searchedBaseProducts = search results (query applied)
  const [searchedBaseProducts, setSearchedBaseProducts] = useState([]);

  // ✅ filteredProducts = sidebar filters applied on top of searchedBaseProducts
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSearchedBaseProducts(products);
  ...
  useEffect(() => {
    ...
    debounceTimeout = setTimeout(() => {
      ...
      // ✅ base = search results
      const base = filtered.length > 0 ? filtered : allProducts;
      setSearchedBaseProducts(base);

      // ✅ also reset filteredProducts to base (filters start fresh for new search)
  ...
  return (
    <div className="shop-font w-full shop-scope">
      {/* ✅ EXACT SAME CSS AS Shop.jsx (this is what makes buttons identical) */}
      <style>{`
        ...
        /* Sidebar: remove bright gradients, no border/shadow */
        .sidebarWrap{
        ...
        /* ✅ Force ALL sidebar primary action buttons to your gradient */
      ...
      <div className="w-full px-3 sm:px-5 lg:px-8 py-4">
        ...
        {/* ✅ layout identical (same gap + widths) */}
        <div className="mt-4 flex flex-col lg:flex-row gap-14 xl:gap-16 2xl:gap-20">
          ...
          <aside className="w-full lg:w-[320px] xl:w-[340px] sidebarWrap">
            <div className="sticky top-20">
              {/* ✅ IMPORTANT: sidebar gets the SEARCHED base products */}
              <FiltersSidebar
                allProducts={searchedBaseProducts}
...
// ===============================================================
// ✅ FILTER SIDEBAR (same UI + same button styles as Shop.jsx)
// ===============================================================
function FiltersSidebar({ allProducts, onFilterChange, initialQuery }) {
  ...
  useEffect(() => {
    ...
    const q = String(initialQuery).toLowerCase();
    let matched = false;
...
// ===============================================================
// ✅ PRODUCT UIs (exact same as Shop.jsx)
// ===============================================================
