...
// // // ✅ LOGIC FIXES (UI unchanged):
// // // 1) Sidebar hides categories/subcategories that have 0 products
// // // 2) Clicking main category shows ALL products in that category + its subcategories
// // // 3) Robust ObjectId handling for populated OR raw ObjectId values
// // // 4) Works even if some products have only subcategory correct (category missing/mismatched)
// // // 5) ✅ FULL ROWS FIX: productsPerPage is always a multiple of the current column count
// // // 6) ✅ Category name click toggles dropdown (same as chevron)
// // // 7) ✅ NEW: Only ONE category dropdown open at a time (clicking another collapses previous)
...
// //         // ✅ Show only active products in Shop page (UI safety)
...
// // // ===============================================================
// // // ✅ FILTER SIDEBAR (LOGIC FIXED)
// // // + Category name click toggles dropdown
// // // + ✅ NEW: Only one open category at a time
// // // ===============================================================
...
// //                   {/* ✅ Clicking category selects + toggles,
// //                       and collapses any previously opened category automatically */}
// //                   <span
...
// //                       if (hasSubs) {
// //                         toggleSingleCategory(cat.categoryName); // ✅ only one open at a time
// //                       } else {
// //                         setExpandedCategories({}); // no subs -> close any open one
// //                       }
// //                     }}
// //                   >
// //                     {cat.categoryName}
...
// // ✅ file: src/pages/shop_pages/Shop.jsx
// // ✅ RESPONSIVE FIX V2 (logic unchanged):
// // 1) Full-width background + proper content gutters
// // 2) Desktop: product grids now have clean gaps + margins
// // 3) Mobile: spacing + typography + buttons tuned
// // 4) Sidebar/main spacing corrected and consistent
// // 5) No filtering / pagination / wishlist logic changed
...
//       // grid view columns
//       if (w >= 1536) return 6; // keep 6 for better spacing; 7 makes it too tight
//       if (w >= 1280) return 6;
//       if (w >= 1024) return 5;
//       if (w >= 768) return 4;
//       if (w >= 640) return 3;
...
//           {/* ✅ max width for beauty (still feels full-width because padding is large) */}
...
// // ===============================================================
// // ✅ PRODUCT UIs (ONLY SPACING FIXES)
// // ===============================================================
// function ProductsGridUI({
//   products,
//   wishlist,
...
// ✅ file: src/pages/shop_pages/Shop.jsx
// ✅ MOBILE FILTER DRAWER ADDED (logic unchanged):
// - Desktop: same layout (sidebar left)
// - Mobile: sidebar becomes a slide-in drawer (Amazon/Flipkart style)
// - Locks body scroll when drawer open
// - Same FiltersSidebar component reused (no functionality lost)
