...
const PAGE_DATA = [
  {
    ...
    title: "ERP systems that simplify operations and improve visibility",
    description:
      "We help businesses streamline workflows, centralize information, and improve decision-making through practical ERP solutions. From custom modules to integrated dashboards, our ERP work focuses on clarity, usability, and operational efficiency.",
    points: [
      "Custom ERP modules for business workflows",
      "Centralized dashboards and reporting",
      "Inventory, finance, and process visibility",
  ...
  },
  {
    ...
    title: "Connected systems that support better planning and execution",
    description:
      "A good ERP platform should reduce fragmentation, improve reporting, and create smoother day-to-day operations. We build systems that make essential business workflows easier to track, manage, and improve over time.",
    points: [
      "Process automation across departments",
      "Business data alignment and reporting",
      "Custom workflows tailored to operations",
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="rounded-[2rem] border border-indigo-100/70 bg-white/80 px-5 py-8 shadow-sm backdrop-blur-sm sm:px-8 sm:py-10 lg:px-12 lg:py-14">
            <span className="text-indigo-700 font-light">ERP &rarr;</span>
            <h1 className="mt-4 text-balance text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
              ERP solutions that connect workflows, data, and decision-making
            </h1>
            <p className="mt-5 max-w-3xl text-sm leading-8 text-gray-600 sm:text-base">
              We build ERP experiences that improve operational clarity, process
              efficiency, and business control without unnecessary complexity.
            </p>
          </div>
        </motion.section>
