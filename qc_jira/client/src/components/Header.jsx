...
// with all careers appliction option in dropdown.
              ...
              <div className="flex items-center gap-4">
                ...
                {!isLoggedIn ? (
                  ...
                  <Menu as="div" className="relative z-50">
                    ...
                    <Menu.Items
                      modal={false}
                      className="absolute right-0 mt-2 w-64 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none border"
                    >
                      <Menu.Item as="div">
                        {({ active }) => (
                          <Link
