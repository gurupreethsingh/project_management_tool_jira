...
function NewsLetter() {
  ...
  return (
    <section className="service-main-wrap">
      <div className="mx-auto container px-4 sm:px-6 lg:px-10 py-10 sm:py-12 lg:py-14">
        <div className="glass-card p-5 sm:p-6 lg:p-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1.1fr),minmax(0,0.9fr)] lg:gap-10 items-start">
            {/* LEFT */}
            <div>
              <p className="service-badge-heading">Newsletter</p>

              <h2 className="mt-3 text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">
                Subscribe to our updates
              </h2>

              <p className="mt-4 service-paragraph max-w-2xl">
                Stay informed about the latest updates in our software,
                automation, testing practices, and product improvements.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-6 max-w-xl">
                ...
                <div className="mt-2.5 flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    type="submit"
                    className="primary-gradient-button justify-center"
                  >
                    Subscribe
                  </button>
                </div>
