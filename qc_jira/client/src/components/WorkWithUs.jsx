...
const WorkWithUs = () => {
    ...
    const fetchSubscriptionCount = async () => {
      try {
        const response = await axios.get(
          `${globalBackendRoute}/api/subscription-count`
        );
  ...
  const stats = [
    ...
    { name: "Softwares/Projects", value: "150" },
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-7xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              We are shaping the future by building cutting-edge AI and
              blockchain applications, delivering transformative solutions that
              empower businesses and redefine industries.
            </p>
          </div>
