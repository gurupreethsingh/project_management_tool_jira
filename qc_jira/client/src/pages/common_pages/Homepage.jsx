...
// //         <div className="absolute top-[-80px] left-1/2 -translate-x-1/2 h-96 w-96  rounded-full animate-pulse" />
...
//                         key={idx}
//                         to={href}
//                         className="group relative overflow-hidden flex items-center justify-between gap-3 px-4 py-3 rounded-xl border border-slate-200 bg-white shadow-sm
//                                    transition-all duration-200 ease-out
//                                    hover:bg-slate-50 hover:shadow-md hover:-translate-y-0.5 hover:scale-[1.01]
...
//                           <span className="absolute -left-1/2 top-0 h-full w-1/2 bg-gradient-to-r from-transparent via-slate-100 to-transparent rotate-12 translate-x-[-120%] group-hover:translate-x-[260%] transition-transform duration-700" />
//                         </span>

//                         <div className="flex items-center gap-3">
//                           <Icon
//                             className={`text-xl ${colorClass} transition-transform duration-200 group-hover:scale-110 group-hover:-rotate-3`}
//                           />
//                           <span className="text-sm font-medium text-slate-800">
//                             {label}
//                           </span>
...
//                         {/* micro arrow that slides in on hover */}
//                         <FaArrowRight className="text-xs text-slate-400 opacity-0 translate-x-1 transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0" />
//                       </Link>
//                     ),
//                   )}
//                 </div>
...
// with background image for the hero section .
...
export default function Homepage() {
  ...
  return (
    <div className="bg-white text-slate-900">
      ...
      >
        {/* ✅ overlay for readability (keeps hero clean + premium) */}
        <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-white/90 to-white/20 border-0" />

        {/* subtle animated glow (kept, but now visible on top of banner) */}
        <div className="absolute inset-0" />
        <div className="absolute top-[-80px] left-1/2 -translate-x-1/2 h-96 w-96 rounded-full animate-pulse opacity-20 bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300" />
