...
//   const [projectsPerPage, setProjectsPerPage] = useState(10); // 0 === All
...
//         {/* Header */}
//         <div className="bg-white/60 backdrop-blur supports-[backdrop-filter]:bg-white/40 rounded-xl border border-slate-200/60 shadow-sm">
//           <div className="p-3 sm:p-4">
//             <div className="flex items-center gap-3">
//               <div className="min-w-0">
//                 <h3 className="text-xl sm:text-2xl font-bold text-indigo-600 truncate">
//                   All Projects
//                 </h3>
//                 <div className="mt-0.5 text-[11px] sm:text-xs text-slate-600">
...
//             {/* Bottom row: search, create, rows + export */}
//             <div className="mt-3 grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-3">
...
//                     className="w-full pl-8 pr-2 py-2 border border-slate-200 rounded-lg bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-200 text-xs"
//                   />
//                 </div>
//               </div>
...
//                 <Link
//                   to={`/create-project`}
//                   className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 text-white text-xs px-3 py-2 shadow-sm hover:bg-indigo-700 transition"
...
//               <div className="md:col-span-6 order-3 md:order-3">
//                 <div className="flex flex-wrap items-center justify-stretch md:justify-end gap-2">
//                   <div className="flex items-center gap-2">
//                     <label className="text-[11px] text-slate-600">Rows</label>
//                     <select
...
//                       <button
//                         onClick={exportXLSX}
//                         className="inline-flex items-center gap-1.5 px-2.5 py-2 border rounded-lg bg-white hover:bg-slate-50 text-xs"
