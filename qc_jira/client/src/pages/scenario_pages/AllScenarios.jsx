...
// //   const [totalScenarios, setTotalScenarios] = useState(0);
// //   const [filteredScenarioCount, setFilteredScenarioCount] = useState(0);
// //   const [projectName, setProjectName] = useState(""); // NEW: for header
...
// //         // Derive project name from scenarios if available
// //         if (data.length > 0) {
// //           const pn =
...
// //   // Filter: module + smart search (tokens, stop-words ignored)
// //   const filtered = useMemo(() => {
// //     const tokens = tokenize(searchQuery); // uses TRIMMED inside
// //     return scenarios.filter((scenario) => {
// //       // Module filter
// //       if (selectedModuleId) {
// //         const mods = getScenarioModules(scenario);
...
// //       // If no search tokens (empty / only stop-words), keep scenario
...
// //       // Match if any token is contained
...
// //       const dateA = new Date(a.createdAt);
// //       const dateB = new Date(b.createdAt);
// //       return sortOrder === "asc" ? dateB - dateA : dateA - dateB; // flip meaning for clarity
// //     });
// //     setScenarios(sorted);
// //     setSortOrder((s) => (s === "asc" ? "desc" : "asc"));
// //   };
...
// //             {/* Search (smart, like AllUsers; raw kept, trimmed internally) */}
// //             <div className="relative">
// //               <FaSearch className="absolute left-3 top-2.5 text-gray-400" />
// //               <input
// //                 type="text"
