  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 items-start">
      {COLUMNS.map((col) => (
        <div
          key={col.key}
          className={`self-start rounded-3xl border ${col.border} ${col.bg} p-3`}
        >
          <div className="h-5 w-28 rounded bg-white/70 animate-pulse" />
          <div className="mt-4 space-y-3">
            {Array.from({ length: 3 }).map((_, i) => (
        ...
        <div className="mx-auto container px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-10">
          ...
          >
            <div className="glass-card p-4 sm:p-5 lg:p-5">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    onClick={() => fetchAll(q, true)}
                    disabled={refreshing || loading}
                    className="inline-flex items-center justify-center rounded-xl border border-slate-300 px-3.5 py-2 text-xs sm:text-sm font-medium text-slate-700 transition-all duration-200 hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    <FaSyncAlt
                      className={`mr-2 ${refreshing ? "animate-spin" : ""}`}
                    />
                  ...
                  <Link
                    to="/create-todo-list"
                    className="primary-gradient-button px-4 py-2 text-xs sm:text-sm"
                  >
                    Create Task
                    <FaArrowRight className="ml-2" />
                  </Link>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1.2fr),220px]">
                <div>
                  <label className="form-label">
                    <span className="form-icon-badge">
                      <FaSearch className="text-[11px]" />
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      onChange={(e) => setQ(e.target.value)}
                      placeholder="Search from backend..."
                      className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:ring-4 focus:ring-slate-100"
                    />
                    ...
                    <button
                      ...
                      onClick={() => fetchAll(q)}
                      disabled={loading}
                      className="inline-flex items-center justify-center rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-medium text-white hover:shadow-md transition disabled:opacity-60"
                    >
                      Apply Search
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-xl border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
                    >
                      Reset
                    </button>
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSearchText(e.target.value)}
                    placeholder="Filter current board..."
                    className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:ring-4 focus:ring-slate-100"
                  />
                </div>
              </div>
                ...
                {selectedDate ? (
                  <>
                    ...
                    <button
                      type="button"
                      onClick={() => setSelectedDate("")}
                      className="inline-flex items-center justify-center rounded-xl border border-slate-300 px-4 py-2 text-xs sm:text-sm font-medium text-slate-700 transition-all duration-200 hover:bg-slate-50"
                    >
                      Clear Date
                    </button>
                  </>
              ...
              <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-3.5 sm:p-4">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <button
                    ...
                    disabled={!selectedCount}
                    onClick={clearSelection}
                    className="inline-flex items-center justify-center rounded-xl border border-slate-300 px-3 py-2 text-xs sm:text-sm font-medium text-slate-700 transition-all duration-200 hover:bg-slate-50 disabled:opacity-50"
                  >
                    Clear Selection
                  </button>
                </div>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    <div className="relative max-w-sm">
                      ...
                      <input
                        ...
                        value={bulkDueDate}
                        onChange={(e) => setBulkDueDate(e.target.value)}
                        className="w-full pl-11 pr-4 py-2.5 rounded-2xl border border-slate-200 bg-white focus:outline-none focus:ring-4 focus:ring-slate-100 text-sm"
                      />
                    </div>
                    ...
                    <button
                      ...
                      disabled={!selectedCount || bulkBusy || !bulkDueDate}
                      onClick={applyBulkReschedule}
                      className="inline-flex items-center justify-center rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-medium text-white disabled:opacity-50"
                    >
                      Apply
                    </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 items-start">
                      {COLUMNS.map((column) => {
                        ...
                        return (
                          <div
                            key={column.key}
                            className={`self-start rounded-3xl border ${column.border} ${column.bg} p-3 sm:p-3.5`}
                          >
                            <div className="flex items-center justify-between mb-3">
                              <div className="text-sm font-semibold text-slate-900">
                                {column.label}
                            ...
                            <Droppable droppableId={column.key}>
                              {(provided) => (
                                ...
                                >
                                  ...
                                  {items.length === 0 && (
                                    <div className="rounded-2xl border border-dashed border-slate-200 bg-white/70 px-3 py-4 text-center text-xs text-slate-500">
                                      No tasks
                                    </div>
                                  )}
